  ...
  <header class="bg-white py-12 border-b border-gray-200">
    <div class="container mx-auto px-4 text-center">
      ...
      <div class="max-w-xl mx-auto flex gap-2">
        <input type="text" placeholder="Search by title..." class="flex-1 p-3 border-2 border-[#197fe6] rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-200">
        <button class="bg-[#197fe6] text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition font-bold">Search</button>
      </div>
    </div>
  </header>
